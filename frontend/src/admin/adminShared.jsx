...
export const SHARED_CSS = `
  ...
  :root{
    ...
    --teal:#0d9488;--teal-bg:rgba(13,148,136,0.1);
  }
  ...
  *::-webkit-scrollbar-thumb{background:rgba(201,168,76,0.4);border-radius:99px}
  ...
  .ap-stat-icon{width:36px;height:36px;border-radius:10px;margin-bottom:.65rem;display:flex;align-items:center;justify-content:center}
  .ap-stat.gold   .ap-stat-icon{background:rgba(201,168,76,0.12);color:#9a7a2e}
  .ap-stat.green  .ap-stat-icon{background:rgba(45,155,111,0.12);color:#2d9b6f}
  .ap-stat.blue   .ap-stat-icon{background:rgba(59,130,246,0.12);color:#3b82f6}
  .ap-stat.orange .ap-stat-icon{background:rgba(245,158,11,0.12);color:#f59e0b}
  .ap-stat.red    .ap-stat-icon{background:rgba(220,53,69,0.1);color:#dc3545}
  .ap-stat.purple .ap-stat-icon{background:rgba(124,58,237,0.1);color:#7c3aed}
  .ap-stat.slate  .ap-stat-icon{background:#f1f5f9;color:#64748b}
  .ap-stat.teal   .ap-stat-icon{background:rgba(13,148,136,0.1);color:#0d9488}
  ...
  .ap-stat-trend{font-size:.7rem;font-weight:600;margin-top:.3rem;display:flex;align-items:center;gap:.25rem}
  .ap-stat-trend.up{color:var(--green)}
  .ap-stat-trend.down{color:var(--red)}
  .ap-stat-trend.flat{color:var(--text-muted)}
  ...
  .ap-panel-title{font-family:'Cormorant Garamond',serif;font-size:1.05rem;font-weight:600;color:var(--text);display:flex;align-items:center;gap:.5rem}
  ...
  .ap-search-ico{position:absolute;left:.75rem;top:50%;transform:translateY(-50%);color:var(--text-muted);pointer-events:none;display:flex;align-items:center}
  ...
  .ap-btn-primary:hover:not(:disabled){background:linear-gradient(135deg,#b09038,#dfc06e);transform:translateY(-1px)}
  ...
  .ap-btn-red:hover{background:rgba(220,53,69,0.14)}
  ...
  .ap-btn-green:hover{background:rgba(45,155,111,0.16)}
  ...
  .ap-empty-ico{margin-bottom:.65rem;display:flex;justify-content:center;opacity:.25}
  ...
  .ap-modal .modal-title{font-family:'Cormorant Garamond',serif;font-size:1.1rem;color:var(--text);font-weight:600;display:flex;align-items:center;gap:.5rem}
...
export function Spinner() { return <div className="ap-spin"/>; }
  ...
  return (
    <div className="ap-pager">
      ...
      <div className="ap-pager-btns">
        <button className="ap-pg wide" disabled={page===1} onClick={()=>setPage(p=>p-1)}>
        ...
        <button className="ap-pg wide" disabled={page===totalPages} onClick={()=>setPage(p=>p+1)}>
...
export function BarChart({ data, height=110, keyVal='total', keyLabel='label' }) {
  ...
  return (
    <div style={{ display:'flex', alignItems:'flex-end', gap:'.45rem', position:'relative', paddingBottom:'1.4rem', height:height+22 }}>
      ...
      {data.map((d,i) => {
        const h2 = Math.max(4, (d[keyVal]/max)*height);
        return (
          <div key={i} style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', gap:'.38rem' }}>
            <div style={{ width:'100%', display:'flex', alignItems:'flex-end', height }}>
              <div style={{ width:'100%', height:h2, borderRadius:'5px 5px 0 0', cursor:'pointer', position:'relative', background:'linear-gradient(to top,rgba(201,168,76,.75),rgba(201,168,76,.3))', transformOrigin:'bottom', animation:`barUp .5s cubic-bezier(.22,1,.36,1) ${i*0.04}s both`, transition:'background .18s' }}
                onMouseEnter={e=>e.currentTarget.style.background='linear-gradient(to top,#C9A84C,rgba(201,168,76,.55))'}
                onMouseLeave={e=>e.currentTarget.style.background='linear-gradient(to top,rgba(201,168,76,.75),rgba(201,168,76,.3))'}
